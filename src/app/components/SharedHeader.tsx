      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 select-none flex-shrink-0">
            <img src={logoImg} alt="Magic Home" className="h-9 w-auto object-contain" />
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="/#portfolio" className="text-gray-600 hover:text-orange-500 text-sm transition-colors" style={{ letterSpacing: "0.02em" }}>
              Portfolio
            </a>
            <a href="/#contact" className="text-gray-600 hover:text-orange-500 text-sm transition-colors" style={{ letterSpacing: "0.02em" }}>
              Contact
            </a>
          </nav>
